...
public:
	...
	ConceptInfo_t *GetConceptInfo( AIConcept_t ai_concept );
	void OnSpokeConcept( CAI_PlayerAlly *pPlayerAlly, AIConcept_t ai_concept, AI_Response *response  );
	...
	bool ConceptDelayExpired( AIConcept_t ai_concept );
...
public:
	...
	virtual void PostSpeakDispatchResponse( AIConcept_t ai_concept, AI_Response *response );
	...
	void		OnSpokeConcept( AIConcept_t ai_concept, AI_Response *response );
